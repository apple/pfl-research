...
class TestQuestionGenerators:
    ...
    @pytest.mark.parametrize(
        'question_generator, min_val, max_val, num_questions, expected', [
            ...
            (lf('int_equidistant_question_generator'), 0, 2, 20, [0.67, 1.33]),
            (lf('int_equidistant_question_generator'), 0, 2, 1, [1.0]),
            (lf('int_equidistant_question_generator'), 0, 2, 2, [0.67, 1.33]),
            (lf('int_equidistant_question_generator'), 5, 8, 2, [6.0, 7.0]),
            ...
            (lf('int_equidistant_question_generator'), 0, 1.6, 1, [0.5]),
        ])
